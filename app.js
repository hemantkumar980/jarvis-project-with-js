...
jarvisComs.push("what's my name");
jarvisComs.push("what's my bio");
jarvisComs.push("tell about yourself");
jarvisComs.push("connection status");
jarvisComs.push("current time");
jarvisComs.push("what's the charging status");
jarvisComs.push("what's the current charge");
jarvisComs.push("what's the temperature");
jarvisComs.push("show the full weather report");
jarvisComs.push("news regarding");
jarvisComs.push("top headlines");
jarvisComs.push("close all tabs");
...
jarvisComs.push("open calendar");
jarvisComs.push("open canva or open my canva designs");
jarvisComs.push("open spotify");
...
jarvisComs.push("open firebase or open fire base");
jarvisComs.push("switch to hindi");
jarvisComs.push("इंग्लिश में बदल");
...
function weather(location) {
  ...
  let url = `https://api.openweathermap.org/data/2.5/weather?q=${location}&appid=43af76e88f4b9c669de54bcbbe1d23d1`;
...
recognition.onresult = function (event) {
  ...
  if(localStorage.getItem("lang") === "en-US"){
    ...
    if (transcript.includes("tell about yourself")) {
      readOut(
        "sir, i am a jarvis, a voice asistant made for browsers using javascript by hemant kumar. I can do anything which can be done from a browser."
      );
    };
